...
# import querying routines that use the Uber and Lyft APIs
    ...
    while True:
        ...
        for location in location_data:
            if total_hr_requests < UBER_REQUEST_LIMIT - 1 and elapsed_time < 3590:
                ...
                try:
                    data = [location, trip_distance, uber_query(location, trip_distance), lyft_query(location, trip_distance)]
                except IndexError:
                    while False:
                        data = [location, trip_distance, uber_query(location, trip_distance), lyft_query(location, trip_distance)]
